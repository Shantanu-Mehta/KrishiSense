  ...
  <div
      ...
      <div   style={{ minHeight: '100vh', background: 'linear-gradient(135deg, #f1f1f1 0%, #e3e8fa 100%)', display: 'flex',
        ...
        style={{ background: '#fff',  padding: '32px', borderRadius: '18px',  minWidth: '420px'}}>
          {/* heading */}
          <h1 style={{color: '#313d5a', fontWeight: 700, letterSpacing: '1px'}}>Login </h1>
          ...
          {/* form */}
            <form onSubmit={handlesSubmit} style={{ display: 'flex', flexDirection: 'column', gap: '19px' }}>
               ...
               <div style={{ display: 'flex', flexDirection: 'column', gap: '6px' }}>
                    ...
                    <label style={{ fontWeight: 500, color: '#25316d' }}> Username or email</label>
            ...
            <p>dont have account?
              <Link to="/signup" style={{ marginLeft: '5px' }}>Signup</Link></p>
